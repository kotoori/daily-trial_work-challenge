...
<main class="l-main">
		<section class="p-archive">
			<div class="l-inner">
				<h1 class="p-archive__title c-heading">新着情報の記事</h1>
				<div class="p-archive__content">
					<div class="c-archive js-tab-parent">
						<ul class="c-archive__tab-list">
							<li class="c-archive__tab-item"><button class="c-tab --blue is-active js-tab" data-color="--blue">新着情報</button></li>
						</ul>
						<div class="c-archive__card-area js-tab-target --blue">
				...
				<div class="p-archive__pagenation">
					<div class="c-pagination">
						<a class="prev page-numbers" href="前ページへのリンク"></a>
						<a class="page-numbers" href="1ページ目へのリンク">1</a>
						<span class="page-numbers current">2</span>
						<a class="page-numbers" href="3ページ目へのリンク">3</a>
						<span class="page-numbers dots">&hellip;</span>
						<a class="page-numbers" href="最後のページへのリンク">15</a>
						<a class="next page-numbers" href="次ページへのリンク"></a>
					</div>
				</div>
			</div>
		</section>
